...
(function ($) {
    $.alert_ext = {
        ...
        defaults: {
            ...
            closeTime: 3000,   // Auto-off time , not less than 1000
        ...
        // Balloon template
        tmpl: '<div class="alert alert-dismissable ${State}"><button type="button" style="padding-left:40px" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><div class="header"><div class="icon">${Icon}</div><strong>${Title}</strong><p>${Content}</p></div></div>',
